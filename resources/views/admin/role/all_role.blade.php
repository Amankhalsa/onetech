...
@section('admin')
    ...
    <a href="{{ route('admin_create_users') }}" class="btn btn-sm btn-warning" style="float: right;">Add New</a>
            </h6>
                ...
                <table id="datatable1" class="table display responsive nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="{{ route('admin_edit_users',$row->id) }} " class="btn btn-sm btn-info">Edit</a>
                        <a href="{{ route('admin_delete_users',$row->id) }}" class="btn btn-sm btn-danger">Delete</a>
                      </td>
